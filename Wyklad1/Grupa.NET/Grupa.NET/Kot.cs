namespace Grupa.NET
{
    ...
    public class Kot : Zwierze           
    {
        ...
        // na poczatku mozemy podac typ widocznosci oraz dodatkowe atrybuty (np override), nastepnie musimy okreslic co zwraca dana metoda oraz nazwe jej [OBOWIAZKOWO].
        // Ponadto w nawiasach podajemy zmienne z ktorych bedziemy mogli korzystac w dzialaniu metody.
